...
import { editReference, filterReferences } from '../../slices/referenceSlice';
...
const EditForm = ({ reference, showForm, setForm }) => {
    ...
    return <RefForm initialValues={ reference } showForm={ showForm } setForm={ setForm } submitFunction={ handleSubmit } />;
}
